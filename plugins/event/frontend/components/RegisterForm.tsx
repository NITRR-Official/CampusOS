...
export function RegisterForm({ eventId }: RegisterFormProps) {
  ...
  return (
    <form className="space-y-3" onSubmit={handleSubmit}>
      <div>
        <label
          className="mb-1 block text-xs font-semibold uppercase tracking-wide text-gray-600 dark:text-gray-400"
        ...
        <input
          ...
          className="w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-background px-3 py-2 text-sm text-foreground outline-none focus:border-primary"
          required
          minLength={2}
          maxLength={80}
        />
      ...
      <button
        type="submit"
        disabled={isLoading}
        className="inline-flex rounded-lg bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground hover:bg-primary/90 disabled:opacity-60"
      >

...
export default function Dashboard() {
  return (
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-10">
          <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight text-foreground mb-3">Welcome to CampusOS</h1>
        ...
        {/* Quick Actions */}
        <div className="mb-8">
          <h2 className="text-xl md:text-2xl font-semibold text-foreground mb-4 md:mb-6 mt-0">Quick Actions</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            <button className="flex flex-col items-center justify-center gap-3 p-6 bg-card text-card-foreground border border-border shadow-sm rounded-xl cursor-pointer transition-all duration-200 hover:border-primary/50 hover:shadow-md hover:-translate-y-1 active:translate-y-0 text-center min-h-[120px]">
              ...
              <span className="text-sm font-semibold tracking-wide">Create Institute</span>
            </button>
            <button className="flex flex-col items-center justify-center gap-3 p-6 bg-card text-card-foreground border border-border shadow-sm rounded-xl cursor-pointer transition-all duration-200 hover:border-primary/50 hover:shadow-md hover:-translate-y-1 active:translate-y-0 text-center min-h-[120px]">
              <span className="text-3xl">➕</span>
              <span className="text-sm font-semibold tracking-wide">Create Club</span>
            </button>
            <button className="flex flex-col items-center justify-center gap-3 p-6 bg-card text-card-foreground border border-border shadow-sm rounded-xl cursor-pointer transition-all duration-200 hover:border-primary/50 hover:shadow-md hover:-translate-y-1 active:translate-y-0 text-center min-h-[120px]">
              <span className="text-3xl">➕</span>
              <span className="text-sm font-semibold tracking-wide">Schedule Event</span>
            </button>
            <button className="flex flex-col items-center justify-center gap-3 p-6 bg-card text-card-foreground border border-border shadow-sm rounded-xl cursor-pointer transition-all duration-200 hover:border-primary/50 hover:shadow-md hover:-translate-y-1 active:translate-y-0 text-center min-h-[120px]">
              <span className="text-3xl">👥</span>
              <span className="text-sm font-semibold tracking-wide">Invite Member</span>
            </button>
          </div>
        </div>
        ...
        {/* Recent Activity */}
        <div className="mb-8">
          <h2 className="text-xl md:text-2xl font-semibold text-foreground mb-4 md:mb-6 mt-0">Recent Activity</h2>
